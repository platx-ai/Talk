        ...
        Form {
            ...
            Section {
                Picker(String(localized: "模型选择"), selection: $settings.llmModelId) {
                    Text("⭐ Qwen3.5-4B (OptiQ, 2.8GB)").tag("mlx-community/Qwen3.5-4B-OptiQ-4bit")
                    Text("Qwen3.5-4B (4-bit, 2.5GB)").tag("mlx-community/Qwen3.5-4B-MLX-4bit")
                    Text("Qwen3.5-2B (4-bit, 1.6GB)").tag("mlx-community/Qwen3.5-2B-4bit")
                    Text("Qwen3-4B (4-bit, 2.1GB)").tag("mlx-community/Qwen3-4B-Instruct-2507-4bit")
                }
